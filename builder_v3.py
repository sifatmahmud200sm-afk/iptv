...
class SM_IPTV_v4:
    def banner(self):
        os.system('clear')
        console.print("[bold cyan]⚡ SM IPTV CUSTOMIZE v4 ⚡[/bold cyan]")
        console.print("[white]Simple & Stable | Original Version[/white]\n")
        ...
        for url in urls:
            try:
                ...
                if r.status_code == 200:
                    # Original Regex for Category, Name, and Link
                    ...
                    console.print(f"[green]✔ Success! {len(matches)} channels found.[/green]")
                else:
